...
function place_order(Request $request){
    ...
    foreach ($cart as $id => $product){
        ...
        DB::table ('order_items')->insert([
                        ...
                        'order_id' => $order_id,
                        'problem_id' => $product_id,
                        'problem_name' =>  $product_name,
                        'problem_price' => $product_price,
                        'problem_quantity' => $product_quantity,
                        'problem_image' =>  $product_image,
                        'order_date' =>  $product_image,
